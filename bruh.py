...
root = './testset/'
Test_Set = 'RNI15'
#print("RNI6 is for black and white images")
#print("RNI15 is for coloured images")
...
if Dir == 'RNI15':
    ...
    elif Test_Img == 'Flowers.png':         sigma = 20
    elif Test_Img == 'Window.png':        sigma = 15
    elif Test_Img == 'j1.jpeg':            sigma = 20
    elif Test_Img == 'j2.jpeg':            sigma = 20
    elif Test_Img == 'j3.jpeg':            sigma = 20

    elif Test_Img == 'j4.jpeg':             sigma = 20
    elif Test_Img == 'j5.jpeg':            sigma = 20
    elif Test_Img == 'gaussian.jpg':            sigma = 30
    elif Test_Img == 'gaussian1.jpg':       sigma = 70
    elif Test_Img == 'gaussian3.png':       sigma = 80
    elif Test_Img == 'gaussian4.png':       sigma = 70
    elif Test_Img == 'gaussian5.png':       sigma = 100
    elif Test_Img == 'gaussian6.png':       sigma = 70
    elif Test_Img == 'gaussian7.png':       sigma = 150
    elif Test_Img == '0000.png':       sigma = 50
    elif Test_Img == '0001.png':       sigma = 50
    elif Test_Img == '0002.png':       sigma = 50
    elif Test_Img == '0003.png':       sigma = 50
    elif Test_Img == '0004.png':       sigma = 50
    elif Test_Img == '0005.png':       sigma = 50
    ...
    elif Test_Img == 'j1.jpeg':            sigma = 12
    elif Test_Img == 'j2.jpeg':            sigma = 15
    elif Test_Img == 'j3.jpeg':            sigma = 15
    elif Test_Img == 'j4.jpeg':            sigma = 16
    elif Test_Img == 'j5.jpeg':            sigma = 16
    elif Test_Img == 'xp1.jpg':            sigma = 16
    elif Test_Img == 'rushicrime.png':            sigma = 100
...
if len(img_clean.shape) == 2:
    ...
    net.load_state_dict(t.load('./model/WDnCNN_model_gray','cuda:0'))
    net.cuda()
    ...
    net.load_state_dict(t.load('./model/WDnCNN_model_color','cuda:0'))
    net.cuda()
    ...
    img_denoised = img_denoised[0:img_clean.shape[0], 0:img_clean.shape[1], :]
    # H,W,_ = img_denoised.shape
    # img_denoised = cv2.resize(img_denoised, (W,H) )
...
cv2.imwrite('./denoisied_figs/noisy.png', np.round(img_n*255), [int(cv2.IMWRITE_PNG_COMPRESSION), 0])
cv2.imwrite('./denoisied_figs/original.png', np.round(img_clean*255), [int(cv2.IMWRITE_PNG_COMPRESSION), 0])
cv2.imwrite('./denoisied_figs/denoised.png', np.round(img_denoised*255), [int(cv2.IMWRITE_PNG_COMPRESSION), 0])
print("Done")
